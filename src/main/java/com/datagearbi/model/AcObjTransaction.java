...
/**
 * The persistent class for the AC_OBJ_TRANSACTION database table.
 * 
 */
@Entity
@Table(name="AC_OBJ_TRANSACTION")
@NamedQuery(name="AcObjTransaction.findAll", query="SELECT a FROM AcObjTransaction a")
public class AcObjTransaction implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy=GenerationType.AUTO)
	@Column(name="ac_obj_transaction_pk")
	private long acObjTransactionPk;
	...
	public AcObjTransaction() {
	}

	public long getAcObjTransactionPk() {
		return this.acObjTransactionPk;
	}

	public void setAcObjTransactionPk(long acObjTransactionPk) {
		this.acObjTransactionPk = acObjTransactionPk;
	}

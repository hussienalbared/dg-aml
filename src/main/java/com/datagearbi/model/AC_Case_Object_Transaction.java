...
/**
 * The persistent class for the AC_Case_Object_Transaction database table.
 * 
 */
@Entity
@NamedQuery(name="AC_Case_Object_Transaction.findAll", query="SELECT a FROM AC_Case_Object_Transaction a")
public class AC_Case_Object_Transaction implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private AC_Case_Object_TransactionPK id;
	...
	public AC_Case_Object_Transaction() {
	}

	public AC_Case_Object_TransactionPK getId() {
		return this.id;
	}

	public void setId(AC_Case_Object_TransactionPK id) {
		this.id = id;
	}

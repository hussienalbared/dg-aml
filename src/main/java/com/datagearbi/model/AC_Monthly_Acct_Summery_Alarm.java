...
/**
 * The persistent class for the AC_Monthly_Acct_Summery_Alarm database table.
 * 
 */
@Entity
@NamedQuery(name="AC_Monthly_Acct_Summery_Alarm.findAll", query="SELECT a FROM AC_Monthly_Acct_Summery_Alarm a")
public class AC_Monthly_Acct_Summery_Alarm implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private AC_Monthly_Acct_Summery_AlarmPK id;
	...
	private int wires_Count;

	@Column(name="Withdrawal_Count")
	private int withdrawal_Count;

	public AC_Monthly_Acct_Summery_Alarm() {
	}

	public AC_Monthly_Acct_Summery_AlarmPK getId() {
		return this.id;
	}

	public void setId(AC_Monthly_Acct_Summery_AlarmPK id) {
		this.id = id;
	}
	...
	public int getWires_Count() {
		return this.wires_Count;
	}

	public void setWires_Count(int wires_Count) {

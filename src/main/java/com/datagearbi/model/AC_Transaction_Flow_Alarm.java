...
/**
 * The persistent class for the AC_Transaction_Flow_Alarm database table.
 * 
 */
@Entity
@NamedQuery(name="AC_Transaction_Flow_Alarm.findAll", query="SELECT a FROM AC_Transaction_Flow_Alarm a")
@Table(name="AC_Transaction_Flow_Alarm",schema="AC")
public class AC_Transaction_Flow_Alarm implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private AC_Transaction_Flow_AlarmPK id;

	@Column(name="Acct_Key")
	private BigDecimal acct_Key;

	@Column(name="Benef_Ext_Cust_Key")
	private BigDecimal benef_Ext_Cust_Key;
	...
	private BigDecimal remit_Ext_Cust_Key;

	@Column(name="Sec_Acct_Key")
	private BigDecimal sec_Acct_Key;
	...
	public AC_Transaction_Flow_Alarm() {
	}

	public AC_Transaction_Flow_AlarmPK getId() {
		return this.id;
	}

	public void setId(AC_Transaction_Flow_AlarmPK id) {
		this.id = id;
	}
	...
	public BigDecimal getBenef_Ext_Cust_Key() {
		return this.benef_Ext_Cust_Key;
	}

	public void setBenef_Ext_Cust_Key(BigDecimal benef_Ext_Cust_Key) {
	...
	public BigDecimal getEmp_Key() {
		return this.emp_Key;
	}

	public void setEmp_Key(BigDecimal emp_Key) {
	...
	public BigDecimal getExec_Ext_Cust_Key() {
		return this.exec_Ext_Cust_Key;
	}

	public void setExec_Ext_Cust_Key(BigDecimal exec_Ext_Cust_Key) {
	...
	public BigDecimal getRemit_Ext_Cust_Key() {
		return this.remit_Ext_Cust_Key;
	}

	public void setRemit_Ext_Cust_Key(BigDecimal remit_Ext_Cust_Key) {
		this.remit_Ext_Cust_Key = remit_Ext_Cust_Key;
	}

	public BigDecimal getSec_Acct_Key() {
		return this.sec_Acct_Key;
	}

	public void setSec_Acct_Key(BigDecimal sec_Acct_Key) {

...
/**
 * The persistent class for the AC_INVESTIGATION_OBJ_TRANSACTION database table.
 * 
 */
@Entity
@Table(name="AC_INVESTIGATION_OBJ_TRANSACTION")
@NamedQuery(name="AcInvestigationObjTransaction.findAll", query="SELECT a FROM AcInvestigationObjTransaction a")
public class AcInvestigationObjTransaction implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private AcInvestigationObjTransactionPK id;
	...
	public AcInvestigationObjTransaction() {
	}

	public AcInvestigationObjTransactionPK getId() {
		return this.id;
	}

	public void setId(AcInvestigationObjTransactionPK id) {
		this.id = id;
	}

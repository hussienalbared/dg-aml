...
/**
 * The persistent class for the DGAML006_Large_Total_Cash_Trans database table.
 * 
 */
@Embeddable
@Table(name="DGAML006_Large_Total_Cash_Trans")
@NamedQuery(name="DGAML006_Large_Total_Cash_Tran.findAll", query="SELECT d FROM DGAML006_Large_Total_Cash_Tran d")
public class DGAML006_Large_Total_Cash_Tran implements Serializable {
	...
	public DGAML006_Large_Total_Cash_Tran() {
	}

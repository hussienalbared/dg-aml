...
/**
 * The primary key class for the AC_Acct_Event_Alarm database table.
 * 
 */
@Embeddable
public class AC_Acct_Event_AlarmPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof AC_Acct_Event_AlarmPK)) {
			return false;
		}
		AC_Acct_Event_AlarmPK castOther = (AC_Acct_Event_AlarmPK)other;
		return 

...
@Entity
@NamedQuery(name = "ExcessiveAccountActivities.findAll", query = "SELECT d FROM ExcessiveAccountActivities d")
@Table(schema = "dbo")
public class ExcessiveAccountActivities implements Serializable {
	...
	public void setAcct_Type_Desc(String acct_Type_Desc) {
		this.accttypedesc = acct_Type_Desc;
	}

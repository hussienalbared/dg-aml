...
/**
 * The persistent class for the DGAML004_CUST_Credit_exceed_INC database table.
 * 
 */
@Embeddable
@NamedQuery(name="DGAML004_CUST_Credit_exceed_INC.findAll", query="SELECT d FROM DGAML004_CUST_Credit_exceed_INC d")
public class DGAML004_CUST_Credit_exceed_INC implements Serializable {
	...
	public DGAML004_CUST_Credit_exceed_INC() {
	}

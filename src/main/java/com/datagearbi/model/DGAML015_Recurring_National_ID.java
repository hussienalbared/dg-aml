...
/**
 * The persistent class for the DGAML015_Recurring_National_ID database table.
 * 
 */
@Embeddable
@NamedQuery(name="DGAML015_Recurring_National_ID.findAll", query="SELECT d FROM DGAML015_Recurring_National_ID d")
public class DGAML015_Recurring_National_ID implements Serializable {
	...
	public DGAML015_Recurring_National_ID() {
	}

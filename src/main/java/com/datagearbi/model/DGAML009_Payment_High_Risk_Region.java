...
/**
 * The persistent class for the DGAML009_Payment_High_Risk_Region database table.
 * 
 */
@Embeddable
@NamedQuery(name="DGAML009_Payment_High_Risk_Region.findAll", query="SELECT d FROM DGAML009_Payment_High_Risk_Region d")
public class DGAML009_Payment_High_Risk_Region implements Serializable {
	...
	public DGAML009_Payment_High_Risk_Region() {
	}

...
////                        + " where Alarmed_Obj_No='" + results.getCust_No()+ "' and Routine_Name='AML002' and Routine_Name= '" + results.getRoutine_Name() + "' and Actual_Value_Txt='" + msg + "'";
...
//                } else {
//
////                    msg = results.getRoutine_message_text().replace("#1", results.getNum_inst());
